    ...
    <div className={`why-us-container ${darkMode ? 'dark' : 'light'}`}>
      ...
      <div className="why-us-content">
        <div className="whysection-header">
          <h2 className="whysection-title">
            DESIGN - STRATEGY - GROWTH WITHOUT LIMITS.
          </h2>
        </div>
        ...
        <div className={`cards-container ${selectedCard ? 'expanded' : ''}`}>
          {!selectedCard ? (
            ...
            <div className="expanded-overlay" onClick={handleBack}>
              {cards.map(
                (card) =>
...
.fact-card-horizontal:nth-child(3) { animation-delay: 0.3s; }
.fact-card-horizontal:nth-child(4) { animation-delay: 0.4s; }
