  ...
  const processSteps = [
    {
      ...
      description:
        'We begin with focused discussions to align goals, define objectives, and establish a strong foundation for overall project success.',
    },
    {
      number: '02',
      ...
      title: 'Design',
      description:
        'Our creative team crafts brand-centered designs that unite striking visuals with functional clarity, delivering engaging, optimized, and memorable user experiences',
    },
    {
      number: '03',
      ...
      description:
        'Expert writers develop clear, compelling content that resonates with your audience, enhances SEO, and effectively communicates your brand message.',
    },
    {
      number: '04',
      ...
      title: 'Development',
      description:
        'Skilled developers transform designs into reality with clean code, advanced technologies, and optimized performance across devices.',
    },
    {
      number: '05',
      ...
      title: 'Production',
      description:
        'We integrate dynamic elements and smooth transitions, enhancing interaction, improving usability, and ensuring memorable user experiences.',
    },
    {
      number: '06',
      ...
      description:
        'Rigorous testing across devices and scenarios ensures flawless functionality, resolving issues and guaranteeing smooth user experiences.',
    },
    {
      number: '07',
        ...
        {windowWidth > 1024 && (
          <div className="process-section__cards-container">
            {processSteps.map((step, index) => (
              ...
              >
                <div
                  className={`process-section__card-content ${activeCard === index ? 'active-content' : 'collapsed-content'}`}
                >
          ...
          >
            <div className="process-section__slider-row">
              {getVisibleCards().map((step, index) => (
                <div
                  key={index}
                  className="process-section__slider-card active"
                >
                  <div className="process-section__card-content active-content">
                    ...
                    <h3 className="process-section__step-title">
                      {step.title}
                    </h3>
                    <div className="process-section__step-description">
                      <p>{step.description}</p>
            ...
            <div className="process-section__slider-controls">
              <button
                className="process-section__slider-btn"
