  ...
  return (
    <div className="marketing-grid-container">
      <div className="marketing-grid-parent">
        ...
        {/* Marketing Section Heading and Description */}
        <div className="marketing-section-content">
          ...
          <p className="marketing-section-description">
            From targeted campaigns to powerful analytics, we help businesses
            reach the right audience, drive engagement, and boost conversions.
          </p>
        </div>
